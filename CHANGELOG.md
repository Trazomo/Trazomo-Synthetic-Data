...
Tagged `v1.31.0` by the integrator at merge (data main `819f003`, 2026-09-25). At tag time the canon rows the PR body proposed landed: `canon/companies.md` co-002 gains its work-location sentence (Wilmington headquarters, the Colorado satellite office, remote employees in New York, Illinois, California, Colorado and Delaware, none in Maryland; HR-15, HR-21) and co-106 the third party candidate assessment module in the AEDT inventory (HR-16); `canon/timeline.md` gains the 2025-09-01 to 2026-09-01 audit currency window, the 2026-01-05 careers page AI-use notices, and the 2026-09-01 run stamp of the three cluster 8 artifacts. The manifest regenerated byte-identical.
