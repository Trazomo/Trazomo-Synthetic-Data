...
export const PROGRAM_GENERATOR_IDS = [
  ...
  hr05.id, hr06.id, hr07.id, hr08.id, hr11.id, hr12.id, hr13.id, hr14.id, hr17.id, hr18.id, hr20.id, hr21.id,
...
const REGISTRY = new Map(
  [
    ...
    hr05, hr06, hr07, hr08, hr11, hr12, hr13, hr14, hr17, hr18, hr20, hr21,
