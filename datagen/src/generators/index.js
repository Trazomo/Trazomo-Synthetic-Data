...
import * as hr05 from "./hr-05-interviewer-calendars.js";
import * as hr06 from "./hr-06-onboarding-checklist-templates.js";
...
import * as hr21 from "./hr-21-employment-ai-watch-list.js";
import * as hr15 from "./hr-15-leave-compliance-roster.js";
import * as hr16 from "./hr-16-aedt-inventory.js";
...
import * as ops08 from "./ops-08-status-inputs.js";
import * as ops09 from "./ops-09-portfolio-rollup.js";
...
export const PROGRAM_GENERATOR_IDS = [
  ...
  hr05.id, hr06.id, hr07.id, hr08.id, hr11.id, hr12.id, hr13.id, hr14.id, hr17.id, hr18.id, hr20.id, hr21.id, hr15.id, hr16.id,
...
const REGISTRY = new Map(
  [
    ...
    hr05, hr06, hr07, hr08, hr11, hr12, hr13, hr14, hr17, hr18, hr20, hr21, hr15, hr16,
