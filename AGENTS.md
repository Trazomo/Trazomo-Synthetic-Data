...
v1.1.0: legal slice (11 drafted artifact sets, 9 datasets) plus the finance cash reconciliation datasets. Check `MANIFEST.json` for what is actually present before assuming a dataset exists.
