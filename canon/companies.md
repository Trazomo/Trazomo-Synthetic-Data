...
| co-106 | TalentForce HR Platform (adopted) | HR, payroll, and benefits platform vendor to co-002 | Critical-risk conditionally-approved vendor assessment in LGL-17; accrual source and SoD test surface in finance (FIN-07, FIN-11); the HRIS-adjacent vendor backdrop for the HR track; the third party candidate assessment module in the AEDT inventory (HR-16) |
