...
| co-102 | Granite Peak Logistics (proposed) | Enterprise customer of co-002, healthy payer | Legal `crm-integration`'s "Enterprise Renewal FY27" record (CORE-03 view); finance AR aging baseline (FIN-04); revenue champion-source account (the old closed-won deal in REV-03); large-counterparty NDA scenario in LGL-17 |
...
| co-104 | Harbor Union Bank (proposed) | Primary bank of co-002 | Bank feed for `finance-cash-bank-reconciliation` (FIN-01), bank balances for FP&A (FIN-32) |
| co-105 | Stonebridge Insurance Services (proposed) | Insurance and facilities vendor to co-002 | Second prepaid schedule source (FIN-12), deliberate distractor from co-101's pattern |
...
| co-107 | Quillstone Office Supply (proposed) | Goods vendor to co-002 | Planted bank-detail change, the fraud-pattern flag in `finance-po-invoice-payment-match` (FIN-07) |
| co-108 | Veranda Labs (proposed) | NDA counterparty of co-002 | The LGL-02 mutual NDA (standard template plus broken QA twin); the NDA that can gate an operations milestone |
| co-109 | Ashgrove Properties (proposed) | Landlord of co-002 | The LGL-03 commercial lease (4-field extraction exercise) |
...
| co-115 | HealthFirst Technologies Inc. (adopted) | Healthcare-technology company, about 3,000 employees; recurring compliance client of co-001 | LGL-14 compliance program bundle (AML policy, training matrix, cert tracker, incident log, board dashboard); the existing-client link in the LGL-08 conflict chain |
...
| co-117 | Redgate Manufacturing (proposed) | Opposing party in co-002's commercial/employment dispute | LGL-11 litigation matter (FRCP deadline chain, trial cascade); LGL-13 discovery production set belongs to this matter |
...
| co-121 | Perigee Systems (proposed) | Competitor of co-002 | Revenue battlecards and competitive prioritization (REV-02, REV-03, CORE-03) |
| co-122 | Bellwether Logistics (proposed) | Target account of co-002 | Qualifying new-hire signal inside the trigger window (REV-03); account fact packet (REV-02) |
...
| co-124 | Osprey Interactive (proposed) | Closed-lost account of co-002 | Re-engagement signal after closed-lost, plus the noise-hire negative case (REV-03); do-not-contact fixture lives on its contacts (REV-01) |
| co-125 | Kestrel Health (proposed) | Target account of co-002; the champion's new employer | Champion employer-change re-link play (REV-03), joining co-102's old closed-won deal |
...
| co-133 | Bright Arc Electrical (proposed) | Electrical subcontractor to co-100 | Labor/subcontractor cost line in job costing (SMB-21) |
| co-134 | Ridgeline Building Supply (proposed) | Materials supplier to co-100 | Materials cost line and miscoded-expense distractor (SMB-21) |
| co-135 | Homeward Realty Group (proposed) | Residential real-estate agency, referral partner of co-100 | Source of referral-loop inbound leads (SMB-25, SMB-03) |
