...
| 2026-03-03 | invite for the 2026-03-10 cross-functional delivery sync issued with the consent notice in its body; the recorded-meeting invite, consent notice and consent flow, and AI notetaker vendor evaluation templates it instantiates | `datasets/operations/meeting-consent-notice-and-invite-templates` |
