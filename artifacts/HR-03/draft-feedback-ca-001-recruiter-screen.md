...
5. Before her last rollout she sat in on support calls for a fortnight and then wrote the work as what the customer experienced, being asked the same question twice and then waiting, rather than as the migration we had been calling it internally, which settled an ordering argument in an afternoon.
